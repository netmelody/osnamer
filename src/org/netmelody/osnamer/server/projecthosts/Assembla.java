...
public final class Assembla implements ProjectHost {

    @Override
    public boolean isHosting(String projectName) {
        FilterBean bean = createFilter(projectName);
        bean.setURL("http://www.assembla.com/search/search?q=" + projectName);
    ...
    private FilterBean createFilter(String projectName) {
        ...
        filter1.setAttributeValue("search-results");
